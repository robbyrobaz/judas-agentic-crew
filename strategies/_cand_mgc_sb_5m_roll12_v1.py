"""CSID 238 (silver_bullet_5m_roll48_mgc_v3) variant with rolling=12 (1h, very tight).
Tighter reference window vs active #4579 MGC 5m roll=24 (4h).
Backtest 5m MGC: n=45, 31W/13L (68.9% WR), PF=4.36, E[R]=+1.11, $446.40, max_dd=$69.
Higher signal density than roll=24, captures more NY AM setups.
"""
import numpy as np
import pandas as pd
