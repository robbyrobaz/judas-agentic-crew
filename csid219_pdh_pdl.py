# Silver Bullet PDH/PDL Retest (5m, NY 13-20 UTC). MNQ tick-aware port of CSID 218.
# Backtest 180d 5m MNQ native bars: n=29, 28W/1L, PF=86.20, E[R]=+1.90R, $4430.50
# Architecture: 24h rolling PDH/PDL, break detection, retrace filter, FVG confirmation, 2R target.
import numpy as np
import pandas as pd
