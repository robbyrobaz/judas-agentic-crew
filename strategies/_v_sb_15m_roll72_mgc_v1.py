# Silver Bullet PDH/PDL Retest (15m, NY 13-20 UTC, rolling PDH/PDL = 72 bars = 18h).
# CSID 219 family, roll=72 variant (between 24 and 96).
#
# Backtest 180d 15m MGC native bars: TBD
...
def evaluate(bars, params):
    ...
    rolling_window = int(params.get("rolling_pdhl_bars", 72))
    min_periods = int(params.get("min_periods", 18))
