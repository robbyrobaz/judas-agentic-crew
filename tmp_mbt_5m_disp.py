# 5m ATR-Relative Displacement Continuation on MBT bitcoin micro
# Adapted from csid156 architecture. Same pattern as DX but bitcoin volatility
# is much higher so we use slightly looser displacement threshold.
