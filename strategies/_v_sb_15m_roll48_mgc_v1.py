...
# CSID 219 family, roll=48 variant (vs. proven 96 = 24h). Faster responsiveness.
#
# Architecture: same as CSID 219 — PDH/PDL via rolling window, break + retest + 3-candle FVG
# confirmation, entry next bar at open.
#
