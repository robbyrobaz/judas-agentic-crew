"""MGC 1H buffet_zoo RSI(10, 30, 70) target_r=1.0 — #4479 exact config baseline."""
import pandas as pd
import numpy as np

PARAMS = {"strategy_type": "rsi", "period": 10, "lo_thr": 30.0, "hi_thr": 70.0,
          "target_r": 1.0, "stop_atr_mult": 1.0, "atr_period": 14}
