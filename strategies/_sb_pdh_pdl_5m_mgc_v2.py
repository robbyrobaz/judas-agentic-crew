...
# Tick-aware MGC port of CSID 218 architecture. NEW CSID candidate.
#
# Architecture:
...
#
# Backtest 180d 5m MGC native bars:
#   n=19, 14W/5L, PF=2.66, E[R]=+1.21R, $128.20
#
# Different from CSID 216 (existing MGC silver_bullet v1) because ticker tick is parameterized
# (0.10 default for MGC) rather than hardcoded 0.1.
...
def evaluate(bars, params):
    ...
    tick = float(params.get("tick", 0.10))  # MGC tick
